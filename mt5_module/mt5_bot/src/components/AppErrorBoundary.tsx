...
type Props = { children: ReactNode; compact?: boolean; resetKey?: string };
...
export default class AppErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    const content = (
        <section className="mx-auto max-w-xl rounded-2xl border border-loss-500/20 bg-[#070b13] p-5 shadow-2xl shadow-black/30">
    ...
    if (this.props.compact) {
      return <div className="py-10 px-2">{content}</div>;
    }
    return <main className="min-h-screen bg-[#04060b] p-4 pt-[12vh] text-slate-200 sm:p-8 sm:pt-[12vh]">{content}</main>;
  }
}
