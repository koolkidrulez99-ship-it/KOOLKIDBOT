...
export const aiControlService = {
  ...
  trialScan: (account_login: number, symbol: string, execution_timeframe: AiTimeframe, bias_timeframe: AiTimeframe): Promise<AiTrialSnapshot> =>
    apiRequest<AiTrialSnapshot>('/api/mt5/ai/trial/scan', 'POST', { account_login, symbol, execution_timeframe, bias_timeframe }),
